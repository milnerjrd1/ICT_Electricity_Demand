...
const SCENARIOS: ScenarioDef[] = [
  ...
  },
  {
    ...
    narrative: 'AI compute demand grows at only 5%/yr — closer to conventional cloud workload growth than the AI boom of 2022–2024. PUE improves at 5%/yr, devices last 20% longer, and network equipment is 15% more efficient. ICT electricity demand grows, but at a pace grid operators can manage.',
    interpretation: 'The soft-landing case. AI still grows at 5%/yr but efficiency improvements prevent runaway demand. Compare against AI Base to isolate the AI demand premium — the additional electricity attributable to the current pace of AI scaling.',
    keyDrivers: [
      '5%/yr AI compute growth (conventional cloud-like trajectory)',
      '5%/yr PUE improvement (achievable with liquid cooling adoption)',
      '15% lower DC utilisation than baseline',
      'Better energy intensity per EFLOP (0.0006 vs 0.001) — newer hardware mix',
      'Longer device lifespans (+20%) and more efficient network equipment (−15%)',
    ],
    watchFor: [
    ...
    params: [
      { key: 'ai_growth_rate', label: 'AI Compute Growth', description: 'Annual growth in AI compute demand', baseline: '20%/yr', value: '5%/yr', direction: 'down' },
      { key: 'pue_improvement_rate', label: 'PUE Improvement', description: 'Annual reduction in Power Usage Effectiveness', baseline: '2%/yr', value: '5%/yr', direction: 'up' },
      ...
      { key: 'ai_kwh_per_eflop', label: 'AI Energy Intensity', description: 'kWh consumed per EFLOP of AI compute', baseline: '0.001', value: '0.0006', direction: 'down' },
      { key: 'avg_lifespan_multiplier', label: 'Device Lifespan', description: 'Multiplier on average device lifespan', baseline: '1.0x', value: '1.2x', direction: 'up' },
      { key: 'power_efficiency_factor', label: 'Network Efficiency', description: 'Multiplier on network equipment power draw', baseline: '1.0x', value: '0.85x', direction: 'down' },
    ],
    ...
    sources: [
      { ref: 'IEA-DC-2024', detail: '5%/yr AI compute growth reflects the lower end of IEA projections, consistent with inference efficiency improvements dominating over new training demand.' },
      { ref: 'UPTIME-PUE-2023', detail: '5%/yr PUE improvement: Uptime Institute Global DC Survey 2023 reports average PUE of 1.58 globally; best-in-class at 1.2–1.3, implying 5%/yr is achievable with aggressive liquid cooling rollout.' },
      { ref: 'CIRCULAR-ECONOMY-EC-2021', detail: 'Device lifespan +20%: EU Ecodesign Regulation (EU) 2021/341 mandates minimum 5–7 year spare parts availability; modelled as 20% lifespan extension vs 2024 baseline.' },
      { ref: 'ERICSSON-MOBILITY-2024', detail: 'Network efficiency −15%: Ericsson Mobility Report 2024 projects 15–20% energy efficiency improvement per bit by 2029 for RAN equipment; −15% is within the projected range.' },
    ],
  },
  {
    id: 'ai_high', family: 'ai_dc', label: 'AI High', color: '#EF4444',
    tagline: 'Accelerated AI build-out — hyperscale capacity doubles by 2030',
    narrative: 'AI compute demand grows at 45%/yr — more than double the baseline rate, consistent with the most aggressive analyst forecasts for AI infrastructure investment through 2027. PUE improvement slows to 1%/yr as demand outpaces engineering capacity. Hyperscale share rises rapidly.',
    interpretation: 'The continued-boom scenario. 45%/yr AI compute growth is within the range of observed 2023–2024 hyperscale capex. Use it to stress-test grid capacity planning and understand the upper bound of near-term DC electricity demand.',
    keyDrivers: [
      '45%/yr AI compute growth (consistent with 2023–2024 hyperscale capex)',
      '1%/yr PUE improvement — demand outpaces efficiency engineering',
      '20% higher DC utilisation than baseline',
      'Worse energy intensity per EFLOP (0.0013) — rapid hardware scaling, older mix',
      'Faster device refresh (−10% lifespan) and higher network load (+10%)',
    ],
    watchFor: [
    ...
    params: [
      { key: 'ai_growth_rate', label: 'AI Compute Growth', description: 'Annual growth in AI compute demand', baseline: '20%/yr', value: '45%/yr', direction: 'up' },
      ...
      { key: 'utilisation_multiplier', label: 'DC Utilisation', description: 'Multiplier on baseline DC utilisation rate', baseline: '1.0x', value: '1.20x', direction: 'up' },
      { key: 'ai_kwh_per_eflop', label: 'AI Energy Intensity', description: 'kWh consumed per EFLOP of AI compute', baseline: '0.001', value: '0.0013', direction: 'up' },
    ...
    sources: [
      { ref: 'GOLDMAN-AI-2024', detail: '45%/yr AI compute growth: Goldman Sachs AI Infrastructure Investment Outlook (2024) projects hyperscale AI capex growing at 40–50%/yr through 2027, implying equivalent compute demand growth.' },
      { ref: 'MSFT-ANNUAL-2024', detail: 'Microsoft FY2024 Annual Report: capex of $55.7bn, up 75% YoY, predominantly for AI infrastructure — corroborates 45%+ annual AI capacity growth.' },
  ...
  },
  {
    ...
    narrative: 'A tail-risk stress test probing the upper bound of plausible ICT electricity demand. AI compute grows at 80%/yr. PUE improvement is minimal (0.5%/yr), DC utilisation is 35% above baseline, and hardware scaling outpaces efficiency. This is not a forecast.',
    ...
    keyDrivers: [
      '80%/yr AI compute growth — extreme but not impossible given 2023 investment trajectories',
      '0.5%/yr PUE improvement — engineering capacity overwhelmed by demand',
      '35% higher DC utilisation than baseline',
      'Worst energy intensity per EFLOP (0.0018) — brute-force scaling with mixed hardware vintage',
    ...
    params: [
      { key: 'ai_growth_rate', label: 'AI Compute Growth', description: 'Annual growth in AI compute demand', baseline: '20%/yr', value: '80%/yr', direction: 'up' },
      ...
      { key: 'utilisation_multiplier', label: 'DC Utilisation', description: 'Multiplier on baseline DC utilisation rate', baseline: '1.0x', value: '1.35x', direction: 'up' },
      { key: 'ai_kwh_per_eflop', label: 'AI Energy Intensity', description: 'kWh consumed per EFLOP of AI compute', baseline: '0.001', value: '0.0018', direction: 'up' },
      { key: 'avg_lifespan_multiplier', label: 'Device Lifespan', description: 'Multiplier on average device lifespan', baseline: '1.0x', value: '0.85x', direction: 'down' },
      { key: 'power_efficiency_factor', label: 'Network Efficiency', description: 'Multiplier on network equipment power draw', baseline: '1.0x', value: '1.15x', direction: 'up' },
    ],
    ...
    sources: [
      { ref: 'EPOCH-AI-2024', detail: '80%/yr AI compute growth: Epoch AI, Trends in Machine Learning Hardware (2024) documents training compute doubling every ~6 months (2020–2024), implying ~150%/yr growth; 80%/yr is a moderated stress-test value.' },
  ...
  },
  {
    ...
    narrative: 'From 2027, electricity grid constraints limit data centre expansion in Ireland, the Netherlands, Great Britain, and Singapore. AI growth slows to 12%/yr as power availability becomes the binding constraint. PUE improvement accelerates to 3.5%/yr as operators are forced to extract more compute per watt.',
    ...
    keyDrivers: [
      ...
      'AI growth slows to 12%/yr — power availability is the binding constraint',
      'PUE improvement accelerates to 3.5%/yr under grid pressure',
      'DC utilisation 20% below baseline — constrained markets cannot fill capacity',
    ],
    watchFor: [
    ...
    params: [
      { key: 'ai_growth_rate', label: 'AI Compute Growth', description: 'Annual growth in AI compute demand', baseline: '20%/yr', value: '12%/yr', direction: 'down' },
      { key: 'pue_improvement_rate', label: 'PUE Improvement', description: 'Annual reduction in Power Usage Effectiveness', baseline: '2%/yr', value: '3.5%/yr', direction: 'up' },
      { key: 'utilisation_multiplier', label: 'DC Utilisation', description: 'Multiplier on baseline DC utilisation rate', baseline: '1.0x', value: '0.80x', direction: 'down' },
      ...
      { key: 'avg_lifespan_multiplier', label: 'Device Lifespan', description: 'Multiplier on average device lifespan', baseline: '1.0x', value: '1.10x', direction: 'up' },
      { key: 'power_efficiency_factor', label: 'Network Efficiency', description: 'Multiplier on network equipment power draw', baseline: '1.0x', value: '0.88x', direction: 'down' },
    ],
  ...
  },
  {
    ...
    narrative: 'Engineering progress dramatically outpaces demand growth. PUE improves at 7%/yr via liquid cooling and AI-optimised chip architectures. AI energy intensity drops to 0.0004 kWh/EFLOP. Network equipment becomes 25% more efficient. AI compute growth slows to 10%/yr as efficiency gains reduce the compute needed per task.',
    interpretation: 'Answers: how much can technology alone reduce ICT electricity demand? Compare against AI Base to isolate the efficiency dividend. Relevant for assessing hardware efficiency standards and DC energy performance regulations.',
    keyDrivers: [
      '7%/yr PUE improvement — liquid cooling, AI-optimised design, best-in-class operations',
      'AI energy intensity at 0.0004 kWh/EFLOP (next-gen accelerators, custom ASICs)',
      '25% improvement in network equipment power efficiency',
      'Device lifespans +25% — longer refresh cycles reduce operational energy',
      'AI growth slows to 10%/yr — efficiency gains reduce compute per task',
    ],
    watchFor: [
      'By 2030, total ICT electricity may be 20–35% below AI Base due to combined efficiency gains and slower AI growth',
    ...
    params: [
      { key: 'ai_growth_rate', label: 'AI Compute Growth', description: 'Annual growth in AI compute demand', baseline: '20%/yr', value: '10%/yr', direction: 'down' },
      { key: 'pue_improvement_rate', label: 'PUE Improvement', description: 'Annual reduction in Power Usage Effectiveness', baseline: '2%/yr', value: '7%/yr', direction: 'up' },
      ...
      { key: 'ai_kwh_per_eflop', label: 'AI Energy Intensity', description: 'kWh consumed per EFLOP of AI compute', baseline: '0.001', value: '0.0004', direction: 'down' },
      { key: 'avg_lifespan_multiplier', label: 'Device Lifespan', description: 'Multiplier on average device lifespan', baseline: '1.0x', value: '1.25x', direction: 'up' },
      { key: 'power_efficiency_factor', label: 'Network Efficiency', description: 'Multiplier on network equipment power draw', baseline: '1.0x', value: '0.75x', direction: 'down' },
    ],
    ...
    sources: [
      { ref: 'GOOGLE-ESR-2024', detail: 'Google Environmental Report 2024: average fleet PUE of 1.10; liquid-cooled TPU pods achieve PUE <1.05. 7%/yr improvement from a global average of ~1.58 is aggressive but technically achievable at scale.' },
      { ref: 'UPTIME-PUE-2023', detail: 'Uptime Institute 2023: global average PUE 1.58; top quartile 1.2–1.3. The gap between average and best-in-class implies 7%/yr improvement is the upper bound of what engineering can deliver.' },
      { ref: 'EPOCH-AI-2024', detail: 'AI energy intensity at 0.0004 kWh/EFLOP: Epoch AI documents ~2× compute efficiency improvement per generation of AI accelerators (2020–2024); 0.0004 reflects two+ hardware generations of improvement.' },
      { ref: 'ERICSSON-MOBILITY-2024', detail: 'Network efficiency −25%: Ericsson Mobility Report 2024 projects 15–20% energy efficiency improvement per bit by 2029 for RAN equipment; −25% represents an optimistic extrapolation to 2035.' },
      { ref: 'EU-ECODESIGN-2021', detail: 'Device lifespan +25%: EU Ecodesign Regulation (EU) 2021/341 and Right to Repair Directive (2024) mandate extended spare parts availability; modelled as 25% lifespan extension vs 2024 baseline.' },
    ],
    specialNotes: [
      'Jevons paradox (cheaper compute inducing more demand) is not modelled — outputs are a lower bound.',
      'PUE of 7%/yr is aggressive but achievable with liquid cooling at scale.',
    ],
  },
];
